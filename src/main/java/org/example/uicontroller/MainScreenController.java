...
public class MainScreenController {
    ...
    @FXML
    private StackPane categoryBox;
    @FXML
    private VBox categoryMenu;
    @FXML
    private StackPane auctionBox;
    @FXML
    private VBox auctionMenu;
    @FXML
    private Label usernameLabel;
    @FXML
    private Button addItemBtn;                    // có trong FXML navbar
    ...
    public void setCurrentUser(User user) {
        ...
        // Hiện nút Add Item chỉ cho Seller
        if (addItemBtn != null && "SELLER".equals(user.getRole())) {
    ...
    /**
     * Cập nhật giá real-time khi nhận UPDATE từ server
     */
